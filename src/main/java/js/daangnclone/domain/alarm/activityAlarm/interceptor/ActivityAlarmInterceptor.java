package js.daangnclone.domain.alarm.activityAlarm.interceptor;
...
@Slf4j
public class ActivityAlarmInterceptor implements HandlerInterceptor {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (modelAndView != null && !isRedirectView(modelAndView) && authentication != null && isTypeOfMember(authentication)) {
            ...
            long count = activityAlarmRepository.countByReceiverAndCheckedYn(receiver, "N");
            modelAndView.addObject("hasActivityAlarm", count > 0);
        }
    }
