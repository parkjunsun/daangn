package js.daangnclone.domain.chatNotification.interceptor;
...
public class ChatNotificationInterceptor implements HandlerInterceptor {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (modelAndView != null && !isRedirectView(modelAndView) && authentication != null && isTypeOfMember(authentication)) {
            ...
            long count = chatNotificationRepository.countByReceiverAndCheckedYn(receiver, "N");
            modelAndView.addObject("hasChatNotification", count > 0);
        }
    }
